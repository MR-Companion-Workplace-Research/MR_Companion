...
public class RealtimeAPIConnection : MonoBehaviour
{
    ...
    [Tooltip("System instructions that define the companion's personality.")]
    [TextArea(3, 10)]
    public string instructions = "You are a friendly companion. Keep responses brief and conversational. You're sitting on the user's desk in mixed reality.";
